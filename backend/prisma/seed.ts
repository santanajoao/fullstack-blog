...
const posts = [
  ...
  { imageUrl: 'https://img.freepik.com/fotos-gratis/feliz-desportista-agua-potavel-no-parque_1098-19542.jpg', createdAt: new Date('2023-06-07'), title: 'Saúde mental em tempos de pandemia', description: 'Saiba como lidar com a ansiedade, o estresse e a depressão em tempos difíceis. Aprenda estratégias simples para cuidar da sua saúde mental.', likes: 14 },
  ...
  { imageUrl: 'https://img.freepik.com/fotos-gratis/esfera-azul-brilhante-segurada-por-mao-humana-gerada-por-ia_188544-41033.jpg', createdAt: new Date('2023-06-06'), title: 'Tecnologia e inovação: as principais tendências para o futuro', description: 'Conheça as novidades que vão revolucionar o mundo da tecnologia nos próximos anos. Saiba mais sobre inteligência artificial, internet das coisas, realidade virtual e outras tendências.', likes: 19 },
  ...
  { imageUrl: 'https://img.freepik.com/fotos-gratis/vista-da-configuracao-e-do-controlador-de-teclado-para-jogos-de-neon-iluminado_23-2149529357.jpg', createdAt: new Date('2023-05-22'), title: 'Jogos e diversão: os melhores games para jogar em 2023', description: 'Confira os melhores jogos para jogar em 2023. Descubra games incríveis para PC, console e celular. Surpreenda-se com gráficos, histórias e jogabilidade.', likes: 17 },
  ...
  { imageUrl: 'https://img.freepik.com/vetores-gratis/conjunto-de-cultura-e-artes_1284-17358.jpg', createdAt: new Date('2023-05-24'), title: 'Cultura e arte: como apreciar as diferentes formas de expressão humana', description: 'Amplie o seu repertório cultural e artístico. Conheça novas formas de expressão humana. Desenvolva o seu senso crítico e estético.', likes: 12 },
  ...
  { imageUrl: 'https://img.freepik.com/fotos-gratis/closeup-de-economista-usando-calculadora-ao-passar-por-contas-e-impostos-no-escritorio_637285-3156.jpg', createdAt: new Date('2023-05-26'), title: 'Finanças pessoais: dicas para economizar', description: 'Organize as suas finanças pessoais e alcance os seus objetivos. Aprenda a fazer um orçamento, economizar, investir e planejar o seu futuro financeiro.', likes: 16 },
];
